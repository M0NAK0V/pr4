    ...
    public Score() {
        ...
        firstTeam.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent a) {
                ...
                Goal_Score.setText("Last Player scored a goal: Sibgatulov Maris");
                Assist_to_Score.setText("Assist to goal: Sestra Marisa");
                winnerUpdate();
        ...
        secondTeam.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent a) {
                ...
                Goal_Score.setText("Last Player scored a goal: Lisin Maxim");
                Assist_to_Score.setText("Assist to goal: Psina Maxima");
                winnerUpdate();
            }
